...
describe('quantiles and fivenum', () => {
  describe('11', () => {
    ...
    it('type7', () => {
      expect(quantilesType7(arr)).toEqual(asB(-1.8620118, -0.84265965, -0.402253, 0.27853255, 1.3709885));
    });
    it('fivenum', () => {
      expect(fivenum(arr)).toEqual(asB(-1.8620118, -0.84265965, -0.402253, 0.27853255, 1.3709885));
    });
  });
  describe('12', () => {
    const arr = [
    ...
    it('type7', () => {
      expect(quantilesType7(arr)).toEqual(asB(-1.222111542, -0.3698675685, 0.3901572565, 1.075091729, 1.57748264));
    });
    it('fivenum', () => {
      expect(fivenum(arr)).toEqual(asB(-1.222111542, -0.378975898, 0.3901572565, 1.078946875, 1.57748264));
    });
  });
